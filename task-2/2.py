...
def BFS(start_list,number_of_nodes,nodege_dict,vizited_nodes={},n=1):
    if len(vizited_nodes)==number_of_nodes or len(start_list)==0:
        ...
        for i in range(len(start_list)):
            ...
            k+=1
        BFS(new_start_list,number_of_nodes,nodege_dict,vizited_nodes=vizited.union(vizited_nodes),n=n+1)
...
BFS([hey],len(node_list),nodege_dict)
